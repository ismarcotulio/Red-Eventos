...
if ($tipo1 != 2) {
	...
	$sql = $db->query("SELECT * FROM categoria WHERE  Nombre NOT IN('$cat1','$cat2','$cat3','$cat4','$cat5','$cat6','$cat7','$cat8','$cat9','$cat10','$cat11','$cat12','$cat13','$cat14','$cat15','$cat16','$cat17','$cat18','$cat19','$cat20') AND Descripcion LIKE '%$value%' OR Nombre NOT IN('$cat1','$cat2','$cat3','$cat4','$cat5','$cat6','$cat7','$cat8','$cat9','$cat10','$cat11','$cat12','$cat13','$cat14','$cat15','$cat16','$cat17','$cat18','$cat19','$cat20') AND Nombre LIKE '%$value%' ");
}else{
	$sql = $db->query("SELECT * FROM categoria WHERE  Nombre NOT IN('$cat1','$cat2','$cat3','$cat4','$cat5','$cat6','$cat7','$cat8','$cat9','$cat10','$cat11','$cat12','$cat13','$cat14','$cat15','$cat16','$cat17','$cat18','$cat19','$cat20') AND Descripcion LIKE '%$value%' AND Id_Clase NOT IN(2) OR Nombre NOT IN('$cat1','$cat2','$cat3','$cat4','$cat5','$cat6','$cat7','$cat8','$cat9','$cat10','$cat11','$cat12','$cat13','$cat14','$cat15','$cat16','$cat17','$cat18','$cat19','$cat20') AND Nombre LIKE '%$value%' AND Id_Clase NOT IN(2) ");
