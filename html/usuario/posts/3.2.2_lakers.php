							...
							<div class="layer" id="layer1">
								<div class="postContenedor" style="">
									<div class="posttituloContenedor" style="">
										<h1 class="postTitulo" style="">lakers</h1>
									</div>
									<hr class="postSeparador" style="">
									<div class="posterContenedor" style="">
										<div style="width:100%; height:100%; background:#c7d7ee;">
											<img class="poster" id="poster" src="http://valleyviewcasinocenter.com/wp-content/uploads/los-angeles-lakers.jpg" alt="" style="">
										</div>
									</div>
									<hr class="postSeparador2" style="">
									<div id="postContenido2" class="postContenido" style="">
										lalala<br>aaa<br>aaa<br><br><br><br>aa<br><div align="center">aaa</div><div align="left">aaa</div><div align="left"><br></div><div align="left"><b>dsdfs</b><br></div>
									</div>
								</div>
							</div>
