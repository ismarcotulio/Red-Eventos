<?php
					...
					?>
						...
						<head>
							<title>maruizkiller || cowboys</title>
							...
							<div class="layer" id="layer1">
								<div class="postContenedor" style="">
									<div class="posttituloContenedor" style="">
										<h1 class="postTitulo" style="">cowboys</h1>
									</div>
									<hr class="postSeparador" style="">
									<div class="posterContenedor" style="">
										<div style="width:100%; height:100%; background:#c7d7ee;">
											<img class="poster" id="poster" src="http://www.dallascowboys.com/sites/dallascowboys.com/files/styles/borealis_no_limit_respondmedium/public/embedded-photos/dcc2_1.jpg?itok=2NPXlFAW&timestamp=1469984688" alt="" style="">
										</div>
									</div>
									<hr class="postSeparador2" style="">
									<div id="postContenido2" class="postContenido" style="">
										a<br>a<br>a<br>a<br>a<br>a<br>a<br>aa<br>a<br>a<br>a<br>a<br>a<br>a<br>a<br><br>
									</div>
								</div>
							</div>
